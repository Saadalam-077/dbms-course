...
const ProfilePage = ({ user, onNavigate, onLogout }) => {
  const labs = [
    { lab: 1, title: "Introduction to DBMS" },
    { lab: 2, title: "Relational Data Model" },
    { lab: 3, title: "SQL Basics - DDL" },
    { lab: 4, title: "SQL Queries - DML" },
    { lab: 5, title: "Advanced SQL Queries" },
    { lab: 6, title: "ER Diagrams" },
    { lab: 7, title: "Normalization" },
    { lab: 8, title: "Indexing & Performance" },
    { lab: 9, title: "Transactions & ACID" },
    { lab: 10, title: "Database Project" },
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-slate-800/50 rounded-2xl p-6 border border-slate-700 mb-8">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 bg-orange-600 rounded-full flex items-center justify-center text-2xl text-white font-bold">{user.studentName.charAt(0)}</div>
            <div>
        ...
        <div className="mt-8 bg-slate-800/50 rounded-2xl p-6 border border-slate-700">
          ...
          <div className="grid grid-cols-5 gap-2 text-center text-sm">
            ...
            <div className="bg-orange-900/30 rounded-lg p-2"><span className="text-orange-400 font-bold">B+</span><p className="text-slate-400">80-84%</p></div>
            <div className="bg-orange-900/20 rounded-lg p-2"><span className="text-orange-300 font-bold">B</span><p className="text-slate-400">75-79%</p></div>
